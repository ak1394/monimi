dojo.provide("monimi.monitor.add.HttpsCheck");
...
// our declared class
dojo.declare("monimi.monitor.add.HttpsCheck", [dijit._Widget, dijit._Templated],
    // class properties:
    {

  	templatePath: dojo.moduleUrl("monimi.monitor.add", "HttpsCheck.html"),	
	...
	addMonitor: function() {
		this.dialog.hide();
		this.controller.addHttpsMonitor(this.fields);
	}
});
