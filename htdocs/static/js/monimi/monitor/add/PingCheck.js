dojo.provide("monimi.monitor.add.PingCheck");
...
// our declared class
dojo.declare("monimi.monitor.add.PingCheck", [dijit._Widget, dijit._Templated],
    // class properties:
    {

  	templatePath: dojo.moduleUrl("monimi.monitor.add", "PingCheck.html"),	
    ...
    postCreate: function() {
		...
		this.fields = {
			...
			host: {name: 'Hostname', textbox: this.checkHostname},
	...
	addMonitor: function() {
		this.dialog.hide();
		this.controller.addPingMonitor(this.fields);
	}
});
